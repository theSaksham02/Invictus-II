...
app.get('/', (req, res) => {
  ...
  res.send('<h1 style="font-family:monospace;color:#00d4ff;background:#020817;padding:2rem">INVICTUS II Ground Station — backend running, dashboard not yet deployed.</h1>');
});
