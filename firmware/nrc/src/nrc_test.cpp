/*
 * INVICTUS II — NRC Rocket Payload Firmware (OLD WORKING VERSION FROM JUNE 17TH)
 * ─────────────────────────────────────────────────────────────────────────────
 * NOTE: To compile this file in PlatformIO:
 *   1. Rename your current 'main.cpp' to 'main_backup.cpp'
 *   2. Rename this 'nrc_test.cpp' to 'main.cpp'
